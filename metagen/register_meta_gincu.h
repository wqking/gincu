...
void registerMain_gincu(Meta _d)
{
    ...
    _d._class(createMetaClass_GEntityDynamicArrayBase());
    _d._class(createMetaClass_GEntityDynamicMap());
    ...
    _d._class(createMetaClass_GHeapPool());
    _d._class(createMetaClass_GHeapSizedPool());
